...
BLOG_AUTHOR = "moaddeli"  # (translatable)
BLOG_TITLE = "AI Saturdays Shiraz"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ai-saturdays-shiraz.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ai-saturdays-shiraz.github.io/"
BLOG_EMAIL = "ai.sat.shiraz@gmail.com"
BLOG_DESCRIPTION = "AI Saturdays(AI6) Shiraz, Iran"  # (translatable)
...
# before </head>
# (translatable)
#EXTRA_HEAD_DATA = "<style>body { font-size: 18px; }</style>"
